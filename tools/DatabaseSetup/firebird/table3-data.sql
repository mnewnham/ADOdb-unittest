...
INSERT INTO testtable_3 (id, varchar_field,	date_field, integer_field,decimal_field,boolean_field, empty_field,number_run_field) values (1, 'LINE 1','2025-01-01',9001,1000.01,TRUE,'',1);
INSERT INTO testtable_3 (id, varchar_field,	date_field, integer_field,decimal_field,boolean_field, empty_field,number_run_field) values (2, 'LINE 2','2025-02-01',9002,1000.11,TRUE,'',2);
INSERT INTO testtable_3 (id, varchar_field,date_field, integer_field,decimal_field,boolean_field, empty_field,number_run_field) values (3, 'LINE 3','2025-03-01',9003,1000.21,null,'',3);
INSERT INTO testtable_3 (id, varchar_field,date_field, integer_field,decimal_field,boolean_field, empty_field,number_run_field) values (4, 'LINE 4','2025-04-01',9004,1000.31,null,'',4);
INSERT INTO testtable_3 (id, varchar_field,date_field, integer_field,decimal_field,boolean_field, empty_field,number_run_field) values (5, 'LINE 5','2025-05-01',9005,1000.41,null,'',5);
