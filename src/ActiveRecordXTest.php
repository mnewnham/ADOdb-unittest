 ...
 */
class ActiveRecordXTest extends ADOdbTestCase
{
    ...
    public function setup(): void
    {
        ...
        if (!$GLOBALS['TestingControl']['activerecord']['extended']) {
            $this->skipFollowingTests = true;
            $this->markTestSkipped(
                'ActiveRecord Extended record handling is not activated'
            );
        }
        parent::setup();
     ...
     * @return void
     */
    public function xtestGetAttributes(): void
    {
     ...
     * @return void
     */
    public function xtestQuoteNames(): void
    {
     ...
     * @return void
     */
    public function xtestAddNewPerson(): void
    {
     ...
     * @return void
     */
    public function xtestAddNewChild(): void
    {
     ...
     * @return void
     */
    public function xtestLoadExistingPersonById(): void
    {
     ...
     * @return void
     */
    public function xtestLoadExistingPersonByMatch(): void
    {
     ...
     * @return void
     */
    public function xtestLoadChildrenByRelation(): void
    {
     ...
     * @return void
     */
    public function xtestLoadChildrenByMatch(): void
    {
     ...
     * @return void
     */
    public function xtestWriteChildData(): void
    {
    ...
    public function xtestGetActiveRecordsIntoArray(): void
    {
     ...
     * @return void
     */
    public function xtestFindMethod(): void
    {
        \ADOdb_Active_Record::TableHasMany('persons', 'children', 'person_id');
