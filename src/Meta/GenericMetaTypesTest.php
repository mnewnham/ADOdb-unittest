...
/**
 * Generic Tests cases for MetaTypes functions of ADODb
 *
 ...
 */
class GenericMetaTypesTest extends MetaFunctions
{
    /**
     ...
     */
    #[DataProvider('providerTestMetaTypes')]
    public function testGenericActualTypesAgainstDataDict(
        mixed $metaType,
        int $fieldLength,
        int $offset,
        string $actualResult
