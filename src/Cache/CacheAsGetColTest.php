 ...
 */
class CacheAsGetColTest extends ADOdbCoreSetup
{
    /**
     ...
     */
    #[DataProvider('providerTestCacheAsGetCol')]
    public function testCacheAsGetCol(mixed $expectedValue, string $sql, ?array $bind): void
    {
