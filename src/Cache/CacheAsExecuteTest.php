 ...
 */
class CacheAsExecuteTest extends ADOdbCoreSetup
{
    /**
     ...
     * @return void
     */
    #[DataProvider('providerTestSelectCacheAsExecute')]
    public function testSelectCacheAsExecute(bool $expectedValue, string $sql, ?array $bind): void
    {
        ...
        foreach ($this->testFetchModes as $fetchMode => $fetchDescription) {
            ...
            $this->assertSame(
                ...
                is_object($result),
                sprintf(
                    '[%s] ADOConnection::cacheExecute() in SELECT mode',
                    $fetchDescription
                )
            );
        }
     ...
     */
    public static function providerTestSelectCacheAsExecute(): array
    {
     ...
     * @return void
     */
    #[DataProvider('providerTestNonSelectCacheAsExecute')]
     ...
     */
    public static function providerTestNonSelectCacheAsExecute(): array
    {
