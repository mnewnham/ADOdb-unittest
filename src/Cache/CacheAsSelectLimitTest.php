 ...
 */
class CacheAsSelectLimitTest extends ADOdbCoreSetup
{
    /**
     ...
     */
    #[DataProvider('providerTestCacheAsSelectLimit')]
    public function testCacheAsSelectLimit(int $fetchMode, array $expectedValue, string $sql, $count, $offset, ?array $bind): void
    {
        $this->db->setFetchMode($fetchMode);


        if ($bind) {
            $result = $this->db->cacheSelectLimit($sql, $count, $offset, $bind);
        } else {
            $result = $this->db->cacheSelectLimit($sql, $count, $offset);
        }
     ...
     *      ]
     */
    public static function providerTestCacheAsSelectLimit(): array
    {
