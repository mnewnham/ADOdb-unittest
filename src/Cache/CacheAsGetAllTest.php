 ...
 */
class CacheAsGetAllTest extends ADOdbCoreSetup
{
    /**
     ...
     * @return void
     */
    #[DataProvider('providerTestCacheAsGetAll')]
    public function testCacheAsGetAll(int $fetchMode, array $expectedValue, string $sql, ?array $bind): void
    {
        ...
        if ($bind) {
            $returnedRows = $this->db->cacheGetAll($sql, $bind);
        } else {
            $returnedRows = $this->db->cacheGetAll($sql);
        }
     ...
     */
    public static function providerTestCacheAsGetAll(): array
    {
