...
/**
 * Tests cases for Dictionary Alter Table functions of ADODb
 *
...
/**
 * Class DataDictAlterTableTest
 *
 * Test cases for for ADOdb DataDictAlterTable
 */
class DataDictAlterTableTest extends DataDictFunctions
{
    /**
     ...
     public function testChangeTableSql(): void
    {
        ...
        if ($errno > 0) {
            $this->fail(
                'Error creating table via the Alter Table data dictionary function '
            );
        }
    }
