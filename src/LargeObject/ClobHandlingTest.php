 ...
 */
class ClobHandlingTest extends ADOdbTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        */
        ...
        $db->Execute($sql);
        $sql = "INSERT INTO blob_storage_table (integer_field) VALUES (9003)";
        $db->Execute($sql);
    ...
    public function testClobDecode(): void
    {
        ...
        $clob = $this->db->blobDecode($clobSelect);
