 ...
 */
class MetaProcedureListTest extends MetaFunctions
{
    /**
 ...
 */
     ...
     * @return void
     */
    public function testMetaProceduresMatchPattern(): void
    {
 ...
 */
        foreach ($this->testFetchModes as $fetchMode => $fetchModeName) {
            ...
            $this->assertIsArray(
                ...
                sprintf(
                    '[FETCH MODE %s] Checking that metaProcedures ' .
                    'returns an array containing 1 record',
                    $fetchModeName
                )
            );
            ...
            $this->assertArrayHasKey(
                ...
                sprintf(
                    '[FETCH MODE %s] Checking that metaProcedures ' .
                    'returns an array containing "sp_recordset_test" procedure',
                    $fetchModeName
                )
            );
            ...
            $this->assertSame(
                ...
                $responseCount,
                sprintf(
                    '[FETCH MODE %s] Checking that the metaProcedures ' .
